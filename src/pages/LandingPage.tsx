...
const socialItems: GlassIconItem[] = [
  {
    ...
    icon: <img src="/assets/icons/linkedin.webp" alt="" className="h-12 w-12 object-contain" />,
  },
  {
    label: 'Discord profile: mikachiq#2706',
    href: 'https://discord.com/',
    caption: 'mikachiq#2706',
    icon: <img src="/assets/icons/discord.png" alt="" className="h-10 w-10 object-contain" />,
  },
  {
    label: 'GitHub profile',
    href: 'https://github.com/mikachiq',
    icon: <img src="/assets/icons/github.png" alt="" className="h-10 w-10 object-contain" />,
  },
];
...
const LandingPage = ({ onNext }: HomeProps) => (
  <motion.div
    ...
    animate="animate"
    exit="exit"
    className="hero-page hero-showcase relative grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(24rem,32rem)] items-center lg:items-stretch gap-8 lg:gap-10 px-4 sm:px-6 max-w-7xl mx-auto text-center md:text-left pt-16 sm:pt-20 md:pt-28 pb-10 md:pb-16"
  >
    <div className="relative z-10 flex h-full flex-col items-center md:items-start gap-6 md:gap-8 lg:pt-10 xl:pt-14">
      <AnimatedItem className="space-y-4 max-w-none">
        <h1 className="text-display hero-title">
          <Typewriter text={"Hi, I'm Atilla Castrodes"} />
        </h1>
      ...
      <AnimatedItem className="w-full flex justify-center md:justify-start lg:mt-auto">
