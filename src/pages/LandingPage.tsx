  ...
  >
    ...
    <AnimatedItem className="hidden lg:flex w-full justify-end">
      <div className="relative w-full max-w-sm sm:max-w-md">
        <div className="relative overflow-hidden rounded-[2.1rem] p-0 shadow-2xl">
          <img
            src="/assets/grad.png"
            alt="Atilla Castrodes graduation portrait"
            className="relative z-10 h-full max-h-[34rem] w-full object-cover object-top rounded-[1.6rem]"
          />
        </div>
      </div>
    </AnimatedItem>
